...
async function appMain() {
    ...
    process.env["AIPY_TOOLS"] = toolsPath;
    console.log("AIPY_TOOLS set to:", toolsPath);
...
function getToolsPath(): string {
    ...
    try {
        ...
        console.log("widgetsJsonPath:", widgetsJsonPath);
    } catch (e) {
        console.error("Error patching widgets.json:", e);
    }
    return basePath;
}
